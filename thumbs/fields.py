...
def generate_thumb(img, thumb_size, format):
    ...
    if thumb_w == thumb_h:
        ...
        # crop it
        image2 = image.crop((xnewsize, ynewsize,
            xsize - xnewsize, ysize - ynewsize))
...
class ImageThumbsFieldFile(ImageFieldFile):
    """
    See ImageThumbsField for usage example
    """
...
class ImageThumbsField(ImageField):
    ...
    Usage example:
    ==============
    photo = ImageThumbsField(upload_to='images', sizes=((125,125),(300,200),)
    ...
    ImageThumbsField will act as a normal ImageField
